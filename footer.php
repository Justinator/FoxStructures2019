...
?>
	...
	<footer id="colophon" class="site-footer">
		<div class="site-info navWidth">
			<div class="col20">
				<a href="<?=site_url()?>"><img src="/wp-content/uploads/2019/01/FoxStructuresLogo-REV.png" class="footerLogo" alt="Fox Structures Logo"><span class="screen-reader-text">Go back to the homepage</span></a>
			</div>
			<div class="col80">
