	...
	<main id="main" class="site-main">
		<section class="pageWidth paddedSection limitPortfolioWidth">
			<div class="centerText">
				<h1 class="centerText portfolioTitle">Forest Brook Farms</h1>
			...
			<section class="project">
				<div class="fullWidth flex-container">
					<div class="col30">
						...
						<ul>
							<li>Industrial wash bay</li>
							<li>Original rustic design</li>
							<li>Custom fabricated staircase</li>
							<li>Hand crafted windows and beams</li>
						</ul>
					</div>
					<div class="col30">
						...
						<div class="underline"></div>
						<ul>
							<li>80’ x 280’ shop, wash bay and storage</li>
							<li>28’ X 54’ office and employee lounge</li>
						</ul>
					</div>
					<div class="col30">
